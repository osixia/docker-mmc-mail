...
sed -i "s|{{ MMC_MAIL_REPLICATION_PASSWORD }}|${MMC_MAIL_REPLICATION_PASSWORD}|g" /container/service/dovecot/assets/config/config-available/replication/config/90-replication.conf
sed -i "s|{{ MMC_MAIL_REPLICATION_HOST }}|${MMC_MAIL_REPLICATION_HOST}|g" /container/service/dovecot/assets/config/config-available/replication/config/90-replication.conf
