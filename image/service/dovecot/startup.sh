...
if [ ! -e "$FIRST_START_DONE" ]; then
    ...
    # adapt cronjobs file
    sed -i "s|{{ MMC_MAIL_DOVECOT_TRASH_EXPUNGE_CRON_EXP }}|${MMC_MAIL_DOVECOT_TRASH_EXPUNGE_CRON_EXP}|g" ${CONTAINER_SERVICE_DIR}/dovecot/assets/cronjobs
	sed -i "s|{{ MMC_MAIL_DOVECOT_TRASH_EXPUNGE_DAYS }}|${MMC_MAIL_DOVECOT_TRASH_EXPUNGE_DAYS}|g" ${CONTAINER_SERVICE_DIR}/dovecot/assets/cronjobs
...
# add cron jobs
ln -sf ${CONTAINER_SERVICE_DIR}/dovecot/assets/cronjobs /etc/cron.d/dovecot
chmod 600 ${CONTAINER_SERVICE_DIR}/dovecot/assets/cronjobs
